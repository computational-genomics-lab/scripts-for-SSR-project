...
THE COMMON MOTIFS (USING INTERSECTION METHOD), STORES THIS INFO IN A CSV FILE. THEN THE PROGRAM LOOPS OVER ALL THE FILES ENTERED (SAY A.SSR, B.SSR) AND FINDS THE SSR REGIONS 
CONTAINING THE COMMON MOTIFS IN OUR CSV FILE. IT STORES INFO ABOUT SSR REGIONS IN A.SSR AND B.SSR AND SAVES THIS IN TWO SEP FILES (common_ssr_A.csv AND common_ssr_B.csv 
RESPECTIVELY)
'''
import pandas as pd
import os
